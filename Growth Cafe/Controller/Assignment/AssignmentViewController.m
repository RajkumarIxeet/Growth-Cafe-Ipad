...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   [cell.lblCourse  setHidden:YES];/////////////////////////////////////////////////////////  done by raj
   ...
   // [cell.btnSubmit setHidden:YES];
    if(assignment.isExpend){
        ...
        [cell.lblAssignementDetail setAttributedText:attributedString];//////////////
        /////////////////////////////////////////////////////////////////////////////////////  done by raj
...
//    cell.lblModule.text=assignment.module.moduleName;
  ...
  //  cell.lblDateAssignment.text=assignment.assignmentSubmittedDate;
    ...
    //////////////////   these lines added for temporary entrying the submit assignment controller by raj
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        return 80.0f;  //   height change from 90 to 80 by raj
